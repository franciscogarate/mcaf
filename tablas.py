...
censo = pd.read_excel('./mcaf/data/censo.xlsx')

permf2000c = pd.read_csv('./mcaf/data/permf2000c.csv',sep=';',decimal=',')
permf2020_col_1ord = pd.read_csv('./mcaf/data/per2020_col_1ord.csv',sep=';',decimal=',')
permf2020_col_2ord = pd.read_csv('./mcaf/data/per2020_col_2ord.csv',sep=';',decimal=',')
permf2012c = permf2020_col_1ord


lx_unisex = pd.read_csv('./mcaf/data/PASEM2020_Decesos_2ord_Unisex.csv')


pasem2020 = pd.read_csv('./mcaf/data/pasem2020.csv',sep=';',decimal=',')
